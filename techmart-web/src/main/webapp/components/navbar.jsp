            ...
            <div class="navbar-nav align-items-lg-center gap-3">
                ...
                <a href="cart.jsp"
                   ...
                   style="font-size: 0.85rem;">
                    ...
                    <span class="badge bg-primary text-white rounded-circle px-1.5 py-0.5"
                ...
                <div class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-sm border-light rounded-3 mt-2"
                        ...
                        <li><a class="dropdown-item py-2 d-flex align-items-center gap-2 text-secondary small"
                               href="profile.jsp"><i class="bi bi-person"></i> My Profile</a></li>
                        <li><a class="dropdown-item py-2 d-flex align-items-center gap-2 text-secondary small"
                               href="myOrders.jsp"><i class="bi bi-bag"></i> Order History</a></li>
                        <li><a class="dropdown-item py-2 d-flex align-items-center gap-2 text-secondary small"
                               href="settings.jsp"><i class="bi bi-gear"></i> Settings</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><a class="dropdown-item py-2 d-flex align-items-center gap-2 text-danger small fw-semibold"
                               href="logout"><i class="bi bi-box-arrow-right"></i> Log Out</a></li>
                    </ul>
                </div>
            </div>
        </div>
